  ...
  return (
    ...
    <div className={toggle?"absolute z-10 p-4 bg-white w-full px-8 md:hidden":"hidden"}>
        <ul>
            ...
            <li className='p-4 hover:bg-gray-100'>Our Story</li>
            <li className='p-4 hover:bg-gray-100' onClick={Signout}>Logout</li>
                
            <li className='p-4 hover:bg-gray-100'>Help</li>
            <div className='flex flex-col my-4 gap-4'>
            {/* <button className='border border-[#039368] flex justify-center items-center hover:bg-black hover:text-white  bg-transparent  px-6 gap-2 py-4'>
                Sign In
            </button> */}
            <button className='px-8 py-5 border rounded-md bg-[#039368]  text-white font-bold'>
                Get Started
            </button>
            </div>
