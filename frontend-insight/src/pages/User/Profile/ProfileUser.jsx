    ...
    <div class="mt-4">
      ...
      <div class="mt-6.5">
        ...
        <div class="flex items-center justify-center gap-4">
          <a
            href="#"
            class="text-black dark:text-white hover:text-primary"
          >
                   <svg
                    className="fill-current"
                    width="22"
...
{/* <div className="overflow-hidden rounded-sm border border-stroke max-w-[80rem] mx-auto bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        <div className="relative z-20 h-35 md:h-65">
          <img
            src={ai}
            alt="profile cover"
            className="h-96 w-full m-1 overflow-x-hidden rounded-tl-sm rounded-tr-sm object-cover object-center"
          />
        ...
        <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
          <div className="relative z-30 mx-auto -mt-22 h-30 w-full max-w-30 rounded-full bg-white/20 p-1 backdrop-blur sm:h-44 sm:max-w-44 sm:p-3">
            <div className="relative drop-shadow-2">
              <img className='rounded-full -m-36 ml-[40%] w-64 '  src={userimg} alt="profile" />
              <label
                htmlFor="profile"
                className="absolute bottom-0 right-0 flex h-8 w-8 cursor-pointer items-center justify-center rounded-full bg-primary text-black hover:bg-opacity-90 sm:bottom-2 sm:right-2"
              >
                <svg
                  className="fill-current"
                  width="14"
